            ...
            <el-col :span="24">
                <el-card class="box-card box-guide">
                    ...
                    <div class="text item">
                        <el-row :gutter="20">
                          <el-col :span="24">
                                <div style="display:inline-block" v-for="(item,index) in guideList" :key="index" draggable="true" @dragstart="dragstart(index)" @dragenter="dragenter($event,index)" @dragover="dragover($event,index)">
                                    <el-card shadow="hover" class="guide_item">
                                        <div class="top">
                                            <div class="top_l">
